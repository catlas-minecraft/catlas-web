...
export const CatlasKysely =
  Context.GenericTag<EffectKysely<CatlasDatabase>>("@catlas/db/CatlasKysely");
...
export const withHistorySchema = (db: EffectKysely<CatlasDatabase>) =>
  withSchema(db, HISTORY_SCHEMA);
export const withDerivedSchema = (db: EffectKysely<CatlasDatabase>) =>
  withSchema(db, DERIVED_SCHEMA);
